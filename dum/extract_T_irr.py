...
def extract_T_irr(datasource,temp_product,response,t_res,yr_start1,yr_end1,yr_start2,yr_end2):
  ...
  if(datasource in ['CRU','CRUv4_CESM','CRU_CESM'] and temp_product in ['tmp_max', 'dtr_max', 'tmx_max', 'tmn_min','tmn_max']):
    ...
    #Load netCDF files
    if datasource == 'CRU':
      #AV_08082019: changed the filepath for the GitHub upload
      #filepath = '/net/exo/landclim/wthiery/observational_analysis/Data/cru_ts3.22.1901.2013.%s.dat.nc'%temp_product
      filepath = 'data/cru_ts3.22.1901.2013.%s.dat.nc'%temp_product
...
#    filepath_PC = '/net/exo/landclim/wthiery/observational_analysis/Data/CESM_output/CESM.WT.1981-2010.%s_20cc_ensmonmean_yearmax.nc'%temp_product
    ...
    #filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Day_max.1m.5arcmin.2002-2018.nc'
    #filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Day_DJF.1m.5arcmin.2003-2010.nc'
    #filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Day_JJA.1m.5arcmin.2003-2010.nc'
    
    #File for climatology
    filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Day_%s.1m.5arcmin.2003-2010.nc'%t_res
    
    #File for sub-grid MODIS-CESM comparison
    #filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Diurn_%s.1m.5arcmin.2003-2010.nc'%t_res
    
    #filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Day_%s.1m.5arcmin.2002-2018.nc'%t_res
    
    Tfile = nc.Dataset(filepath,'r')
    
    HIDfile = nc.Dataset('/home/vissera/Documents/Data/HID_regridded/hid_v1.0.f_irr_hyde_final_ir.5arc-minutes.10y.1900-2005.nc','r')
    ...
    T_output[1,:,:] = Tfile.variables['LST_Day_CMG'][0,:,:]
    T_output[0,:,:][~np.isnan(T_output[1,:,:])] = 0.
    
  elif datasource == "MODIS_CESM_TS":
    
    #filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Day_max.1m.0.9375x1.25.2003-2010.timmean.nc'
    #filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Day_MAM_CESM.1m.0.9375x1.25.2003-2010.timmean.nc'
    filepath = '/home/vissera/Documents/Data/MODIS_LST_regridded/MODIS_LST_MYD11C3_v006_LST_Diurn_MAM.1m.0.9375x1.25.2003-2010.nc'
    
    Tfile = nc.Dataset(filepath,'r')
    
    TS_PD = Tfile.variables['LST_Day_CMG'][0,:,:]
    print TS_PD.shape
    ...
    T_output[1,:,144:288] = TS_PD[:,0:144]
    T_output[1,:,0:144] = TS_PD[:,144:288]
    T_output[0,:,:][~np.isnan(T_output[1,:,:])] = 0.
    
  elif datasource == "CESM_TS":
    
    #filepath = '/home/vissera/Documents/Data/CESM_output/CESM_out_wthiery_irr_ensmean_TS_yearmax_2003-2010.nc'
    filepath = '/home/vissera/Documents/Data/CESM_output/CESM_out_wthiery_irr_ensmean_TS_MAM_2003-2010.nc'
    
    Tfile = nc.Dataset(filepath,'r')
    
    n_lat = Tfile.variables['lat'][:]
    n_lon = Tfile.variables['lon'][:]
    
    T_output = np.zeros((2,n_lat.shape[0],n_lon.shape[0]))
    T_output[:,:,:] = np.nan
    
    TS_PD = Tfile.variables['TS'][0,:,:]
...
#T_out = extract_T_irr('MODIS','TREFHT','PD','yearmean',1901,1930,1981,2010)
